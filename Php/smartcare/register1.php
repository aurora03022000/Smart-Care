...
if(isset($_POST['name']) && isset($_POST['gender']) && isset($_POST['number']) && isset($_POST['birthdate']) && isset($_POST['address']) && isset($_POST['disease']) && isset($_POST['deviceID']) && isset($_POST['room'])  && isset($_POST['encoder'])){
    ...
    $sql = "INSERT INTO patient(patient_name, gender, number, birthdate, address, disease, deviceID, room, encoder, date_admit, isExist) VALUES('$name', '$gender', '$number', '$birthdateFinal', '$address', '$disease', '$deviceID', '$room', '$encoder', '$newDateAdmitted', 1) ";
