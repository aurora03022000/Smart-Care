...
public class NewBloodPressureDialogBox extends AppCompatDialogFragment {

    private NewBloodPressureDialogBox.dialogListener listener;
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState){
        ...
        View view = inflater.inflate(R.layout.dialog_box_blood_pressure, null);
        ...
        /*saveBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                handler.postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        String bloodPressure = newValue.getText().toString();

                        getPatientID(bloodPressure);
    ...
    public void onAttach(@NonNull Context context) {
        ...
        try {
            listener = (NewBloodPressureDialogBox.dialogListener) context;
    ...
    public interface dialogListener{
        void applyTexts2(String value);
    }


    private void getPatientID(String bloodPressure) {
            ...
            public void onResponse(String response) {
                ...
                if(!response.equals("failure")){
                    ...
                    if(response.equals("")){
                        ...
                        valueToEdit = "Blood Pressure";
                        updateData(bloodPressure, valueToEdit, patientID);
                    }
