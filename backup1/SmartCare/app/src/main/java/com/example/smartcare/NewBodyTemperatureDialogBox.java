...
public class NewBodyTemperatureDialogBox extends AppCompatDialogFragment {

    private NewBodyTemperatureDialogBox.dialogListener listener;
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState){
        ...
        View view = inflater.inflate(R.layout.dialog_box_body_temperature, null);
        ...
        /*saveBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                handler.postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        String bodyTemperature = newValue.getText().toString();

                        getPatientID(bodyTemperature);
    ...
    public void onAttach(@NonNull Context context) {
        ...
        try {
            listener = (NewBodyTemperatureDialogBox.dialogListener) context;
    ...
    public interface dialogListener{
        void applyTexts3(String value);
    }

    private void getPatientID(String bodyTemperature) {
            ...
            public void onResponse(String response) {
                ...
                if(!response.equals("failure")){
                    ...
                    if(response.equals("")){
                        ...
                        valueToEdit = "Body Temperature";
                        updateData(bodyTemperature, valueToEdit, patientID);
                    }
        ...
        StringRequest request = new StringRequest(Request.Method.POST, url, new com.android.volley.Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if(response.equals("success")){
                    ...
                    progressDialog6.setContentView(R.layout.success_save_bloodpressure);
