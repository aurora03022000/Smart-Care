...
public class NewAirQualityDialogBox extends AppCompatDialogFragment {

    private NewAirQualityDialogBox.dialogListener listener;
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState){
        ...
        View view = inflater.inflate(R.layout.dialog_box_air_quality, null);
        ...
        /*saveBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                handler.postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        String airQuality = newValue.getText().toString();
                        getPatientID(airQuality);
                    }
                }, 2000);
            }
        });*/
    ...
    public void onAttach(@NonNull Context context) {
        ...
        try {
            listener = (NewAirQualityDialogBox.dialogListener) context;
    ...
    public interface dialogListener{
        void applyTexts1(String value);
    }

    private void getPatientID(String airQuality) {
            ...
            public void onResponse(String response) {
                ...
                if(!response.equals("failure")){
                    ...
                    if(response.equals("")){
                        ...
                        patientID = response;
                        valueToEdit = "Air Quality";

                        updateData(airQuality, valueToEdit, patientID);
                    }
        ...
        StringRequest request = new StringRequest(Request.Method.POST, url, new com.android.volley.Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if(response.equals("success")){
                    ...
                    progressDialog6.setContentView(R.layout.success_save_airquality);
