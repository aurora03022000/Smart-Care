...
public class NewPulseRateDialogBox extends AppCompatDialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState){
        ...
        View view = inflater.inflate(R.layout.dialog_box_pulse_rate, null);
        ...
        /*saveBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                handler.postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        String pulseRate = newValue.getText().toString();
                        getPatientID(pulseRate);
                    }
                }, 2000);
            }
        });
    ...
    private void getPatientID(String pulseRate) {
            ...
            public void onResponse(String response) {
                ...
                if(!response.equals("failure")){
                    ...
                    if(response.equals("")){
                        ...
                        patientID = response;
                        valueToEdit = "Pulse Rate";

                        updateData(pulseRate, valueToEdit, patientID);
                    }
        ...
        StringRequest request = new StringRequest(Request.Method.POST, url, new com.android.volley.Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if(response.equals("success")){
                    ...
                    progressDialog6.setContentView(R.layout.success_save_pulse_rate);
