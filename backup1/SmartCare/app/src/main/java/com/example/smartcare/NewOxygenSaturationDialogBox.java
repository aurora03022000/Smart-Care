...
public class NewOxygenSaturationDialogBox extends AppCompatDialogFragment {

    private NewOxygenSaturationDialogBox.dialogListener listener;
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState){
        ...
        View view = inflater.inflate(R.layout.dialog_box_oxygen_saturation, null);
        ...
        /*saveBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                handler.postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        String oxygenSaturation = newValue.getText().toString();
                        getPatientID(oxygenSaturation);
                    }
                }, 2000);
    ...
    public void onAttach(@NonNull Context context) {
        ...
        try {
            listener = (NewOxygenSaturationDialogBox.dialogListener) context;
    ...
    public interface dialogListener{
        void applyTexts5(String value);
    }

    private void getPatientID(String oxygenSaturation) {
            ...
            public void onResponse(String response) {
                ...
                if(!response.equals("failure")){
                    ...
                    if(response.equals("")){
                        ...
                        valueToEdit = "Oxygen Saturation";

                        updateData(oxygenSaturation, valueToEdit, patientID);
                    }
        ...
        StringRequest request = new StringRequest(Request.Method.POST, url, new com.android.volley.Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if(response.equals("success")){
                    ...
                    progressDialog6.setContentView(R.layout.success_save_oxygen_saturation);
