...
public class LiveMonitoring extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.live_monitoring);
        ...
        progressDialog = new ProgressDialog(LiveMonitoring.this);
        progressDialog.show();
        ...
        refresh.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intentShareMenu = new Intent(LiveMonitoring.this, LiveMonitoring.class);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                returnPress = returnPress + "f";

                Intent intentShareMenu = new Intent(LiveMonitoring.this, Monitoring.class);
                intentShareMenu.putExtra("USER_ID", currentUser);
                intentShareMenu.putExtra("RETURN", returnPress);
                intentShareMenu.putExtra("FIRST_TIME", "no");
                startActivity(intentShareMenu);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                switch (menuItem.getItemId())
                {
                    case  R.id.nav_home:
                        ...
                        Intent intentHome = new Intent(LiveMonitoring.this, Home.class);
                    ...
                    case  R.id.contact:
                        ...
                        Intent intentContact = new Intent(LiveMonitoring.this, Contact.class);
                    ...
                    case  R.id.about:
                        ...
                        Intent intentAbout = new Intent(LiveMonitoring.this, About.class);
                    ...
                    case  R.id.logout:
                        new AlertDialog.Builder(LiveMonitoring.this)
                                .setMessage("Are you sure you want to logout?")
                                .setCancelable(false)
                                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                                    @Override
                                    public void onClick(DialogInterface dialog, int which) {
                                        Intent intentLogout = new Intent(LiveMonitoring.this, Login.class);
    ...
    public void onBackPressed() {
        ...
        if(returnPress.equals("0")){
            ...
            Intent intentPatient = new Intent(LiveMonitoring.this, Patient.class);
            ...
            Intent intentAccount = new Intent(LiveMonitoring.this, Account.class);
            ...
            Intent intentDismiss = new Intent(LiveMonitoring.this, DismissPatient.class);
            ...
            Intent intentDismiss = new Intent(LiveMonitoring.this, Monitoring.class);
            intentDismiss.putExtra("USER_ID", currentUser);
            intentDismiss.putExtra("RETURN", returnPress);
            intentDismiss.putExtra("FIRST_TIME", "no");
            startActivity(intentDismiss);
            ...
            Intent intentPatientLogs = new Intent(LiveMonitoring.this, PatientLogs.class);
            ...
            Intent intentSharedPatient = new Intent(LiveMonitoring.this, SharePatient.class);
            ...
            Intent intentSearchShare = new Intent(LiveMonitoring.this, SearchUserShare.class);
            ...
            Intent intentRegister = new Intent(LiveMonitoring.this, Register.class);
            ...
            Intent intentShareMenu = new Intent(LiveMonitoring.this, SharingMenu.class);
            intentShareMenu.putExtra("USER_ID", currentUser);
            intentShareMenu.putExtra("RETURN", returnPress);
            intentShareMenu.putExtra("FIRST_TIME", "no");
            startActivity(intentShareMenu);
            ...
            Intent intentShareMenu = new Intent(LiveMonitoring.this, PatientInfo.class);
            intentShareMenu.putExtra("USER_ID", currentUser);
            intentShareMenu.putExtra("RETURN", returnPress);
            intentShareMenu.putExtra("FIRST_TIME", "no");
            startActivity(intentShareMenu);
    ...
    private void getProfile(String currentUserID) {
        ...
        RequestQueue queue = Volley.newRequestQueue(LiveMonitoring.this);
            ...
            public void onResponse(String response) {
                ...
                if(!response.equals("failure")){
                    ...
                    if(response.equals("")){
                        ...
                        Glide.with(LiveMonitoring.this).load("http://192.168.254.114:8080/SmartCare/"+response).into(profile);
                        ...
                        if(profileString.equals("profile/")){
                            ...
                            progressDialog1 = new ProgressDialog(LiveMonitoring.this);
                            ...
                            handler.postDelayed(new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    LinearLayout refreshLinearLayout = new LinearLayout(LiveMonitoring.this);
                                    ...
                                    refreshLinearLayout.setForeground(ContextCompat.getDrawable(LiveMonitoring.this, resId));
                                    refreshLinearLayoutParams.gravity = Gravity.CENTER;
                                    refreshLinearLayout.setGravity(Gravity.CENTER);
                                    refreshLinearLayout.setBackground(ContextCompat.getDrawable(LiveMonitoring.this, R.drawable.register_button_layout));
                                    refreshLinearLayout.setLayoutParams(refreshLinearLayoutParams);
                                    middleLayout.addView(refreshLinearLayout);


                                    TextView textViewRefreshIcon = new TextView(LiveMonitoring.this);
                                    ...
                                    textViewRefreshIcon.setBackground(ContextCompat.getDrawable(LiveMonitoring.this, R.drawable.refresh_icon));
                                    textViewRefreshIcon.setLayoutParams(textViewRefreshIconParams);
                                    refreshLinearLayout.addView(textViewRefreshIcon);

                                    TextView textViewRefreshText = new TextView(LiveMonitoring.this);
                                    ...
                                    Typeface typeface = ResourcesCompat.getFont(LiveMonitoring.this, R.font.poppinsbold);
                                    ...
                                    TextView textViewRefreshSubtext = new TextView(LiveMonitoring.this);
                                    ...
                                    Typeface typeface1 = ResourcesCompat.getFont(LiveMonitoring.this, R.font.poppinsmedium);
                                    ...
                                    refreshLinearLayout.setOnClickListener(new View.OnClickListener() {
                                        ...
                                        public void onClick(View v) {
                                            ...
                                            Intent intentAbout = new Intent(LiveMonitoring.this, LiveMonitoring.class);
                                            intentAbout.putExtra("USER_ID", currentUser);
                                            intentAbout.putExtra("RETURN", returnPress);
                                            intentAbout.putExtra("FIRST_TIME", "no");
                                            startActivity(intentAbout);
                ...
                //kung ang response is success
                    ...
                    progressDialog2 = new ProgressDialog(LiveMonitoring.this);
                    ...
                    handler.postDelayed(new Runnable() {
                        ...
                        public void run() {
                            ...
                            Intent intentAbout = new Intent(LiveMonitoring.this, SharingMenu.class);
                            intentAbout.putExtra("USER_ID", currentUser);
                            intentAbout.putExtra("RETURN", returnPress);
                            intentAbout.putExtra("FIRST_TIME", "no");
                            startActivity(intentAbout);
        ...
        StringRequest request = new StringRequest(Request.Method.POST, url, new com.android.volley.Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                //kung ang response is success
                    ...
                    progressDialog3 = new ProgressDialog(LiveMonitoring.this);
    ...
    private void getPatientName(){
        // url to post our data
        String url = "http://"+ipAddress+"/SmartCare/getPatientName.php";
    ...
    private void getLiveMonitoringIPAddress(){
        // url to post our data
        String url = "http://"+ipAddress+"/SmartCare/getIPAddress.php";
        ...
        StringRequest request = new StringRequest(Request.Method.POST, url, new com.android.volley.Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                //kung ang response is success
                    ...
                    progressDialog4 = new ProgressDialog(LiveMonitoring.this);
                    progressDialog4.show();
                    progressDialog4.setContentView(R.layout.failure_retrieve_ip_address);
