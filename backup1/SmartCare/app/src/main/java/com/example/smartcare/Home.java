...
public class Home extends AppCompatActivity {
    ...
    LinearLayout patient_list_btn, register_patient_btn, remove_patient_btn, share_patient_btn, share_menu_btn, information;
...
//        information = findViewById(R.id.information);
        ...
        register_patient_btn = findViewById(R.id.register_patient_btn);
//        remove_patient_btn = findViewById(R.id.remove_patient_btn);
//        all = findViewById(R.id.all);
        ...
        patient_list_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intentPatientList = new Intent(Home.this, Patient.class);
                intentPatientList.putExtra("USER_ID", currentUser);
                intentPatientList.putExtra("RETURN", returnPress);
                intentPatientList.putExtra("FIRST_TIME", "no");
                startActivity(intentPatientList);
                finish();
            }
        });

        register_patient_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                Intent intentRegister = new Intent(Home.this, Register.class);
...
//
//        remove_patient_btn.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View v) {
//
//                if(returnPress.equals("!")){
...
//                }
//
//                Intent intentRemove = new Intent(Home.this, DismissPatient.class);
//                intentRemove.putExtra("USER_ID", currentUser);
//                intentRemove.putExtra("RETURN", returnPress);
//                intentRemove.putExtra("FIRST_TIME", "no");
...
//            public void onClick(View v) {
//                returnPress = returnPress + "0";
//                Intent intentShare = new Intent(Home.this, SharePatient.class);
//                intentShare.putExtra("USER_ID", currentUser);
//                intentShare.putExtra("RETURN", returnPress);
//                intentShare.putExtra("FIRST_TIME", "no");
...
//            public void onClick(View v) {
//                returnPress = returnPress + "0";
//                Intent intentShareMenu = new Intent(Home.this, SharingMenu.class);
...
//            public void onClick(View v) {
//                returnPress = returnPress + "0";
//                Intent intentShareMenu = new Intent(Home.this, PatientInfo.class);
//                intentShareMenu.putExtra("USER_ID", currentUser);
//                intentShareMenu.putExtra("RETURN", returnPress);
//                intentShareMenu.putExtra("FIRST_TIME", "no");
//                startActivity(intentShareMenu);
...
//                }
//
//                Intent intentAll = new Intent(Home.this, AllMenu.class);
//                intentAll.putExtra("USER_ID", currentUser);
//                intentAll.putExtra("RETURN", returnPress);
//                intentAll.putExtra("FIRST_TIME", "no");
...
//        });
    ...
    public void onBackPressed() {
        ...
        if(returnPress.equals("0")){
            ...
            Intent intentAbout = new Intent(Home.this, Home.class);
            intentAbout.putExtra("USER_ID", currentUser);
            intentAbout.putExtra("RETURN", returnPress);
            intentAbout.putExtra("FIRST_TIME", "no");
            startActivity(intentAbout);
            ...
            Intent intentAbout = new Intent(Home.this, Patient.class);
            intentAbout.putExtra("USER_ID", currentUser);
            intentAbout.putExtra("RETURN", returnPress);
            intentAbout.putExtra("FIRST_TIME", "no");
            startActivity(intentAbout);
...
//            returnPress = concatinatedReturnPress;
//
//            Intent intentAbout = new Intent(Home.this, AllMenu.class);
//            intentAbout.putExtra("USER_ID", currentUser);
//            intentAbout.putExtra("RETURN", returnPress);
//            intentAbout.putExtra("FIRST_TIME", "no");
//            startActivity(intentAbout);
...
//        }
            ...
            Intent intentAbout = new Intent(Home.this, Account.class);
            intentAbout.putExtra("USER_ID", currentUser);
            intentAbout.putExtra("RETURN", returnPress);
            intentAbout.putExtra("FIRST_TIME", "no");
            startActivity(intentAbout);
            ...
            Intent intentAbout = new Intent(Home.this, Contact.class);
            intentAbout.putExtra("USER_ID", currentUser);
            intentAbout.putExtra("RETURN", returnPress);
            intentAbout.putExtra("FIRST_TIME", "no");
            startActivity(intentAbout);
            ...
            Intent intentAbout = new Intent(Home.this, DismissPatient.class);
            intentAbout.putExtra("USER_ID", currentUser);
            intentAbout.putExtra("RETURN", returnPress);
            intentAbout.putExtra("FIRST_TIME", "no");
            startActivity(intentAbout);
            ...
            Intent intentDismiss = new Intent(Home.this, Monitoring.class);
            ...
            Intent intentPatientLogs = new Intent(Home.this, PatientLogs.class);
            ...
            Intent intentSharedPatient = new Intent(Home.this, SharePatient.class);
            ...
            Intent intentSearchShare = new Intent(Home.this, SearchUserShare.class);
            ...
            Intent intentShareMenu = new Intent(Home.this, LiveMonitoring.class);
            intentShareMenu.putExtra("USER_ID", currentUser);
            intentShareMenu.putExtra("RETURN", returnPress);
            intentShareMenu.putExtra("FIRST_TIME", "no");
            startActivity(intentShareMenu);
            ...
            public void onResponse(String response) {
                ...
                if(!response.equals("failure")){
                    ...
                    if(response.equals("")){
                        ...
                        Glide.with(Home.this).load("http://192.168.254.114:8080/SmartCare/"+response).into(profile);
                        ...
                        if(profileString.equals("profile/")){
                            ...
                            handler.postDelayed(new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    LinearLayout refreshLinearLayout = new LinearLayout(Home.this);
                                    ...
                                    refreshLinearLayout.setForeground(ContextCompat.getDrawable(Home.this, resId));
                                    refreshLinearLayoutParams.gravity = Gravity.CENTER;
                                    refreshLinearLayout.setGravity(Gravity.CENTER);
                                    refreshLinearLayout.setBackground(ContextCompat.getDrawable(Home.this, R.drawable.register_button_layout));
                                    refreshLinearLayout.setLayoutParams(refreshLinearLayoutParams);
                                    middleLayout.addView(refreshLinearLayout);


                                    TextView textViewRefreshIcon = new TextView(Home.this);
                                    ...
                                    textViewRefreshIcon.setBackground(ContextCompat.getDrawable(Home.this, R.drawable.refresh_icon));
                                    textViewRefreshIcon.setLayoutParams(textViewRefreshIconParams);
                                    refreshLinearLayout.addView(textViewRefreshIcon);

                                    TextView textViewRefreshText = new TextView(Home.this);
                                    ...
                                    Typeface typeface = ResourcesCompat.getFont(Home.this, R.font.poppinsbold);
                                    ...
                                    TextView textViewRefreshSubtext = new TextView(Home.this);
                                    ...
                                    Typeface typeface1 = ResourcesCompat.getFont(Home.this, R.font.poppinsmedium);
                ...
                //kung ang response is success
                    ...
                    progressDialog2 = new ProgressDialog(Home.this);
        ...
        StringRequest request = new StringRequest(Request.Method.POST, url, new com.android.volley.Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                //kung ang response is success
                    ...
                    progressDialog3 = new ProgressDialog(Home.this);
    ...
    private void getHistory(String currentUserID){
        // url to post our data
        String url = "http://"+ipAddress+"/SmartCare/getHistory.php";
        ...
        StringRequest request = new StringRequest(Request.Method.POST, url, new com.android.volley.Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if(!response.equals("failure")){
                    ...
                    if(response.equals("")){
                        ...
                        if(profileString.equals("<br")){
                            ...
                            progressDialog4 = new ProgressDialog(Home.this);
                ...
                //kung ang response is success
                    ...
                    progressDialog5 = new ProgressDialog(Home.this);
                    progressDialog5.show();
                    progressDialog5.setContentView(R.layout.error_retrieve_name);
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                progressDialog6 = new ProgressDialog(Home.this);
