...
public class NewRoomTemperatureDialogBox extends AppCompatDialogFragment {

    private NewRoomTemperatureDialogBox.dialogListener listener;
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState){
        ...
        View view = inflater.inflate(R.layout.dialog_box_room_temperature, null);
        ...
        /*saveBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                handler.postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        String roomTemperature = newValue.getText().toString();

                        getPatientID(roomTemperature);
                    }
                }, 2000);
            }
        });*/
    ...
    public void onAttach(@NonNull Context context) {
        ...
        try {
            listener = (NewRoomTemperatureDialogBox.dialogListener) context;
    ...
    public interface dialogListener{
        void applyTexts7(String value);
    }

    private void getPatientID(String roomTemperature) {
            ...
            public void onResponse(String response) {
                ...
                if(!response.equals("failure")){
                    ...
                    if(response.equals("")){
                        ...
                        valueToEdit = "Room Temperature";

                        updateData(roomTemperature, valueToEdit, patientID);
                    }
        ...
        StringRequest request = new StringRequest(Request.Method.POST, url, new com.android.volley.Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if(response.equals("success")){
                    ...
                    progressDialog6.setContentView(R.layout.success_save_room_temperature);
