...
public class SharePatient extends AppCompatActivity {
    ...
    LinearLayout share_all_button, share_menu_button, parentLayout, centerLayout, spaceLinearLayout;
    ...
    ProgressDialog progressDialog8, progressDialog9, progressDialog10;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        share_all_button = findViewById(R.id.share_all_button);
        share_menu_button = findViewById(R.id.share_menu_button);
        spaceLinearLayout = findViewById(R.id.spaceLinearLayout);

        share_all_button.setVisibility(View.GONE);
        share_menu_button.setVisibility(View.GONE);
        spaceLinearLayout.setVisibility(View.GONE);
        ...
        progressDialog = new ProgressDialog(SharePatient.this);
        progressDialog.show();
        ...
        share_all_button.setEnabled(false);
        share_all_button.setBackground(ContextCompat.getDrawable(this, R.drawable.disable_layout));

        share_all_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                if(numberOfPatient != 0){
                    ...
                    progressDialog10 = new ProgressDialog(SharePatient.this);
                    progressDialog10.show();
                    progressDialog10.setContentView(R.layout.progress_bar);
        ...
        share_menu_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                returnPress = returnPress + "9";

                Intent intentSearchShare = new Intent(SharePatient.this, SharingMenu.class);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                switch (menuItem.getItemId())
                {
                    case  R.id.nav_home:
                        ...
                        Intent intentHome = new Intent(SharePatient.this, Home.class);
                    ...
                    case  R.id.contact:
                        ...
                        Intent intentContact = new Intent(SharePatient.this, Contact.class);
                    ...
                    case  R.id.about:
                        ...
                        Intent intentAbout = new Intent(SharePatient.this, About.class);
                    ...
                    case  R.id.logout:
                        ...
                        new AlertDialog.Builder(SharePatient.this)
                                .setMessage("Are you sure you want to logout?")
                                .setCancelable(false)
                                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                                    @Override
                                    public void onClick(DialogInterface dialog, int which) {
                                        Intent intentLogout = new Intent(SharePatient.this, Login.class);
    ...
    public void onBackPressed() {
        ...
        if(returnPress.equals("0")){
            ...
            Intent intentAbout = new Intent(SharePatient.this, Home.class);
            intentAbout.putExtra("USER_ID", currentUser);
            intentAbout.putExtra("RETURN", returnPress);
            intentAbout.putExtra("FIRST_TIME", "no");
            startActivity(intentAbout);
            ...
            Intent intentAbout = new Intent(SharePatient.this, Patient.class);
            intentAbout.putExtra("USER_ID", currentUser);
            intentAbout.putExtra("RETURN", returnPress);
            intentAbout.putExtra("FIRST_TIME", "no");
            startActivity(intentAbout);
...
//            returnPress = concatinatedReturnPress;
//
//            Intent intentAbout = new Intent(SharePatient.this, AllMenu.class);
//            intentAbout.putExtra("USER_ID", currentUser);
//            intentAbout.putExtra("RETURN", returnPress);
//            intentAbout.putExtra("FIRST_TIME", "no");
//            startActivity(intentAbout);
...
//        }
            ...
            Intent intentAbout = new Intent(SharePatient.this, Account.class);
            intentAbout.putExtra("USER_ID", currentUser);
            intentAbout.putExtra("RETURN", returnPress);
            intentAbout.putExtra("FIRST_TIME", "no");
            startActivity(intentAbout);
            ...
            Intent intentAbout = new Intent(SharePatient.this, Contact.class);
            intentAbout.putExtra("USER_ID", currentUser);
            intentAbout.putExtra("RETURN", returnPress);
            intentAbout.putExtra("FIRST_TIME", "no");
            startActivity(intentAbout);
            ...
            Intent intentAbout = new Intent(SharePatient.this, DismissPatient.class);
            intentAbout.putExtra("USER_ID", currentUser);
            intentAbout.putExtra("RETURN", returnPress);
            intentAbout.putExtra("FIRST_TIME", "no");
            startActivity(intentAbout);
            ...
            Intent intentDismiss = new Intent(SharePatient.this, Monitoring.class);
            ...
            Intent intentPatientLogs = new Intent(SharePatient.this, PatientLogs.class);
            ...
            Intent intentSearchShare = new Intent(SharePatient.this, SearchUserShare.class);
            intentSearchShare.putExtra("USER_ID", currentUser);
            intentSearchShare.putExtra("RETURN", returnPress);
            intentSearchShare.putExtra("FIRST_TIME", "no");
            startActivity(intentSearchShare);
            ...
            Intent intentRegister = new Intent(SharePatient.this, Register.class);
            ...
            Intent intentShareMenu = new Intent(SharePatient.this, SharingMenu.class);
            ...
            Intent intentShareMenu = new Intent(SharePatient.this, PatientInfo.class);
            intentShareMenu.putExtra("USER_ID", currentUser);
            intentShareMenu.putExtra("RETURN", returnPress);
            intentShareMenu.putExtra("FIRST_TIME", "no");
            startActivity(intentShareMenu);
            ...
            Intent intentShareMenu = new Intent(SharePatient.this, LiveMonitoring.class);
            intentShareMenu.putExtra("USER_ID", currentUser);
            intentShareMenu.putExtra("RETURN", returnPress);
            intentShareMenu.putExtra("FIRST_TIME", "no");
            startActivity(intentShareMenu);
    ...
    private void getStaffName(String currentUserID){
        ...
        RequestQueue queue = Volley.newRequestQueue(SharePatient.this);
        ...
        StringRequest request = new StringRequest(Request.Method.POST, url, new com.android.volley.Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if(!response.equals("failure")){
                    ...
                    if(response.equals("")){
                        ...
                        if(profileString.equals("<br")){
                            ...
                            progressDialog1 = new ProgressDialog(SharePatient.this);
                            ...
                            handler.postDelayed(new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    LinearLayout refreshLinearLayout = new LinearLayout(SharePatient.this);
                                    ...
                                    refreshLinearLayout.setForeground(ContextCompat.getDrawable(SharePatient.this, resId));
                                    refreshLinearLayoutParams.gravity = Gravity.CENTER;
                                    refreshLinearLayout.setGravity(Gravity.CENTER);
                                    refreshLinearLayout.setBackground(ContextCompat.getDrawable(SharePatient.this, R.drawable.register_button_layout));
                                    refreshLinearLayout.setLayoutParams(refreshLinearLayoutParams);
                                    middleLayout.addView(refreshLinearLayout);


                                    TextView textViewRefreshIcon = new TextView(SharePatient.this);
                                    ...
                                    textViewRefreshIcon.setBackground(ContextCompat.getDrawable(SharePatient.this, R.drawable.refresh_icon));
                                    textViewRefreshIcon.setLayoutParams(textViewRefreshIconParams);
                                    refreshLinearLayout.addView(textViewRefreshIcon);

                                    TextView textViewRefreshText = new TextView(SharePatient.this);
                                    ...
                                    Typeface typeface = ResourcesCompat.getFont(SharePatient.this, R.font.poppinsbold);
                                    ...
                                    TextView textViewRefreshSubtext = new TextView(SharePatient.this);
                                    ...
                                    Typeface typeface1 = ResourcesCompat.getFont(SharePatient.this, R.font.poppinsmedium);
                                    ...
                                    refreshLinearLayout.setOnClickListener(new View.OnClickListener() {
                                        ...
                                        public void onClick(View v) {
                                            ...
                                            Intent intentAbout = new Intent(SharePatient.this, SharePatient.class);
                                            intentAbout.putExtra("USER_ID", currentUser);
                                            intentAbout.putExtra("RETURN", returnPress);
                                            intentAbout.putExtra("FIRST_TIME", "no");
                                            startActivity(intentAbout);
                ...
                //kung ang response is success
                    ...
                    progressDialog4 = new ProgressDialog(SharePatient.this);
            ...
            public void onResponse(String response) {
                ...
                if(!response.equals("failure")){
                    ...
                    if(response.equals("")){
                        ...
                        Glide.with(SharePatient.this).load("http://192.168.254.114:8080/SmartCare/"+response).into(profile);
                        ...
                        editAccount.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent intentAccount = new Intent(SharePatient.this, Account.class);
                ...
                //kung ang response is success
                    ...
                    progressDialog5 = new ProgressDialog(SharePatient.this);
                    progressDialog5.show();
                    progressDialog5.setContentView(R.layout.error_retrieve_profile);
        ...
        StringRequest request = new StringRequest(Request.Method.POST, url, new com.android.volley.Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                //kung ang response is success
                    ...
                    progressDialog6 = new ProgressDialog(SharePatient.this);
                    progressDialog6.show();
                    progressDialog6.setContentView(R.layout.failure_get_patient_number);
        ...
        StringRequest request = new StringRequest(Request.Method.POST, url, new com.android.volley.Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                //kung ang response is success
                    ...
                    progressDialog7 = new ProgressDialog(SharePatient.this);
    ...
    public void addPatientInfo(String responseResult) {
        ...
        for(;;){
            ...
            if(responseResult.equals(" ") || responseResult.equals("")){
                ...
                int resId = getSelectableItemBackground();
                newLinearLayoutChildParent.setForeground(ContextCompat.getDrawable(SharePatient.this, resId));
                ...
                textViewPatientContent.setCompoundDrawablesWithIntrinsicBounds(0, 0, R.drawable.share_patient_icon, 0);
                ...
                newLinearLayoutChildParent.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        progressDialog2 = new ProgressDialog(SharePatient.this);
        ...
        share_all_button.setVisibility(View.VISIBLE);
        share_menu_button.setVisibility(View.VISIBLE);
        spaceLinearLayout.setVisibility(View.VISIBLE);

        if(numberOfPatient == 0){
            LinearLayout centerLayout;
            centerLayout = findViewById(R.id.centerLayout);

            LinearLayout newLinearLayoutChildParent = new LinearLayout(SharePatient.this);
            LinearLayout.LayoutParams params1Parent = new LinearLayout.LayoutParams(
                    LinearLayout.LayoutParams.MATCH_PARENT,
                    LinearLayout.LayoutParams.WRAP_CONTENT
            );
            ...
            TextView noPatient = new TextView(SharePatient.this);
            LinearLayout.LayoutParams params3 = new LinearLayout.LayoutParams(
                    LinearLayout.LayoutParams.WRAP_CONTENT,
                    LinearLayout.LayoutParams.WRAP_CONTENT
            );
            ...
            Typeface typeface = ResourcesCompat.getFont(SharePatient.this, R.font.poppinsmedium);
            ...
            share_all_button.setEnabled(true);
            share_all_button.setBackground(ContextCompat.getDrawable(this, R.drawable.register_button_layout));
        }
...
//        int childHeight = centerLayout.getHeight();
        ...
        if(childHeight < parentHeight){
            ...
            share_menu_button.setLayoutParams(paramsBottom);
        ...
        StringRequest request = new StringRequest(Request.Method.POST, url, new com.android.volley.Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if(response.equals("success")){
                    ...
                    Intent intentStaffList = new Intent(SharePatient.this, SearchUserShare.class);
                    ...
                    progressDialog3 = new ProgressDialog(SharePatient.this);
                    progressDialog3.show();
                    progressDialog3.setContentView(R.layout.connectionfailure);
                    ...
                    progressDialog8 = new ProgressDialog(SharePatient.this);
                    progressDialog8.show();
                    progressDialog8.setContentView(R.layout.failure_to_update_shared_option);
        ...
        StringRequest request = new StringRequest(Request.Method.POST, url, new com.android.volley.Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                //kung ang response is success
                    ...
                    progressDialog9 = new ProgressDialog(SharePatient.this);
                    progressDialog9.show();
                    progressDialog9.setContentView(R.layout.failure_update_current_shared_patient_id);
