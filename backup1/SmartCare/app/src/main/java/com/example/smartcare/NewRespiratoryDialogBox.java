...
public class NewRespiratoryDialogBox extends AppCompatDialogFragment {

    private NewRespiratoryDialogBox.dialogListener listener;
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState){
        ...
        View view = inflater.inflate(R.layout.dialog_box_respiratory_rate, null);
        ...
        /*saveBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                handler.postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        String respiratoryRate = newValue.getText().toString();

                        getPatientID(respiratoryRate);
                    }
                }, 2000);
    ...
    public void onAttach(@NonNull Context context) {
        ...
        try {
            listener = (NewRespiratoryDialogBox.dialogListener) context;
    ...
    public interface dialogListener{
        void applyTexts6(String value);
    }

    private void getPatientID(String respiratoryRate) {
            ...
            public void onResponse(String response) {
                ...
                if(!response.equals("failure")){
                    ...
                    if(respiratoryRate.equals("")){
                        ...
                        valueToEdit = "Respiratory Rate";

                        updateData(respiratoryRate, valueToEdit, patientID);
                    }
        ...
        StringRequest request = new StringRequest(Request.Method.POST, url, new com.android.volley.Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if(response.equals("success")){
                    ...
                    progressDialog6.setContentView(R.layout.success_save_respiratory);
